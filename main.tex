...
Poachers are of course finite, and each has individual factors that will affect his or her behaviour. However, for the purpose of this model we assume an infinite number of "average" poachers since, over a long time scale, these assumptions hold true. By predicting over a long time scale we can discern the overall affect of dehorning on poacher behaviour.
