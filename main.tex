...
% The approach described in this paper builds previous and investigates the interactions  between the poachers using evolutionary game theory. 
Using evolutionary game theory, this paper determines which strategy is preferred by the poacher in various different populations of poachers.
...
used by wild life managers to deter poachers for more than 20 years, as well as other devaluing techniques such as GPS tracking, poison and dyes. 
...
case, the more rhinos which are dehorned, the less probability that a poacher will be selective. Therefore, even in the scenario with a disincentive, the proportion of rhinos which could be saved is limited.

The disincentive factor can have several interpretations. The government
could either force a more severe sentence for rhino poaching, or through
education. Through education we can instill an appreciation for the animal to the
future generation of `possible' poachers. Likewise, a financial incentive for 
selective behaviour would be an incentive for poaching.
