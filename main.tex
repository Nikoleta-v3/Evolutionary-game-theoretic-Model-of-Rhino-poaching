...
model this is be represented by \(\chi=(x_1, x_2)\) with \(x_1\) being the proportion
...
As evident from the scenarios considered, all populations converge 
...
that being selective is not the best response even in a population where
