...
indiscriminately to have any source of utility. A mixed population can be stable
...
controlling \(r\), as shown on Fig.~\ref{fig:convergence-over-r}. This is
evident in the first two plots of Fig.~\ref{fig:convergence-over-r}, where
a difference in the value of \(r\) can  change the point of convergence from a mixed to
a selective one. Moreover, the manager can also manipulate how fast 
the population convergences, as shown in the last two plots of
Fig.~\ref{fig:convergence-over-r}. Fig~\ref{fig:equilibrium-over-r-tilde-u} 
shows the  equilibrium for \(x\) for a number of different values of \(r\), 
and indicates that  having a large \(r\) pushes poachers to behave indiscriminately.
As demonstrated in Fig~\ref{fig:equilibrium-over-H-tilde-u}, a higher value of
\(H\) also has an non-ideal effect on the poachers. Thus, high values of \(H\) and 
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.5\textwidth]{images/new-utility-over_r.pdf}
...
\begin{figure}[!htbp]
\centering
    \includegraphics[width=0.5\textwidth]{images/new-utility-over_H.pdf}
    \caption{Equilibrium behaviour with a disincentive with different values of \(H\).
     For \(F=50, r=0.6 \beta=2, \gamma=1, \theta_r=0.6\).}
...
used by wild life managers to deter poachers for more than 20 years. 
Dehorning can be effective if and only if poachers chose to behave in a 
