...
can be stable with this disincentive. This is illustrated in Fig.~\ref{fig:ess-new-utility}
...
Fig.~\ref{fig:ess-new-utility} indicates that having a large \(r\) pushes poachers
to behave indiscriminately. Fig.~\ref{fig:equilibrium-over-r-tilde-u} shows the
