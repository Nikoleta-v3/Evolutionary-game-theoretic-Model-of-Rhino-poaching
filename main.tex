...
% In our case \(x\) represents the proportion of selective poachers and \(1- x\) represents 
% the proportion of indiscriminate poachers.
% The equilibria of the differential equation (\ref{eqn:u_differential_simplified})
% are given by, \(x=1\) (all poachers are selective), \(x=0\) (all poachers are 
% indiscriminate), and \(0<x<1\) (a mix of poachers) for \(u_1(x)=u_2(x)\).
% These equilibria correspond to stability of the population: the differential 
% equation (\ref{eqn:u_differential_simplified}) no longer changes. 
