...
\textit{Keywords}:  Evolutionary dynamics, Game theory, Poachers' interactions ,
Rhinoceros, Wildlife.
\newpage
%=============================================
...
Note that poachers are of course finite, and each has individual factors that will
affect a poacher's behaviour. However, for the purpose of this model we assume an
infinite number of "average" poachers since, over a long time scale, these assumptions
hold true. By predicting over a long time scale we can discern the overall affect
of dehorning on poacher behaviour.
...
All authors conceived the ideas and designed methodology. NG and VK developed the
