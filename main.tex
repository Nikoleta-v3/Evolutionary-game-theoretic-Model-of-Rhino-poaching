...
Finally, another result showing that dehorning as many Rhinos as possible is
perhaps not the best option.

\begin{theorem}
    Using the modified utility model described and assuming that \(r<1\) then
    the required disincentive is increasing in \(r\).
\end{theorem}

% TODO Write proof (the one with the derivative of the full bound if possible)

This is illustrated in Figure ... % TODO Solve the differential equations
% numerically with the new utility
% TODO Add a comment
...
% TODO We will need to modify this section.
...
\begin{figure}[!htbp]
    % TODO This needs to be moved and possibly moved with the discussion 
    \centering
