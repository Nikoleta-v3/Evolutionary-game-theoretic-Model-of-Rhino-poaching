...
\(x_1\) represents the proportion of selective poachers and \(x_2\) represents 
the proportion of indiscriminate poachers.
...
A poacher interacts with the population, denoted as \(\chi=(x,1-x)\) where \(x\)
...
of the proportion of selective poachers only, \(\chi=x\). Therefore, the amount
of horn gained in the general case is
...
proportion of selective poachers. Note that since \(\theta_r, r, x  \in [0, 1]\), then
...
% is the proportion of selective poachers, and \(1-x\) is the proportion of indiscriminate
% poachers. For simplicity, from herein the population \(\chi\) is referred to in terms
% of the proportion of selective poachers only, \(\chi=x\). 
Therefore, the gain for a poacher in the population \(\chi\) is either
...
Note that a selective poacher needs more time to secure an `available' 
rhino, if they exist at all. Hence, there is an additional cost that tends to 
infinity as \(r \rightarrow 1\), 
