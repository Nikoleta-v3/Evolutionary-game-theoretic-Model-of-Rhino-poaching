...
selectively. We suggest that a new strategy could be introduced, which would correspond
to a third option of not poaching this particular environment. This could correspond
to not poaching at all (perhaps through better opportunities) or choosing to leave
the current environment and poach elsewhere.
