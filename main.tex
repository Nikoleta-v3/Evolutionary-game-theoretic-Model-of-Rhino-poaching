...
controlling \(r\), as shown in Fig.~\ref{fig:convergence-over-r}. This is
evident in Fig.~\ref{fig:convergence-over-r}, where
...
\(H\) also has a non-ideal effect on the poachers. Thus, high values of \(H\) and 
